class DeezerR {
  ...
  DeezerR({this.data, this.total, this.next});

  DeezerR.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = new List<Data>();
      json['data'].forEach((v) {
...
class Data {
  ...
  @override
  String toString() {
    return 'Data{id: $id, readable: $readable, title: $title, titleShort: $titleShort, titleVersion: $titleVersion, link: $link, duration: $duration, rank: $rank, explicitLyrics: $explicitLyrics, explicitContentLyrics: $explicitContentLyrics, explicitContentCover: $explicitContentCover, preview: $preview, artist: $artist, album: $album, type: $type}';
  }
}
