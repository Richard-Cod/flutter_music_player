...
class SongPlaying extends StatefulWidget {
  ...
  @override
  _SongPlayingState createState() => _SongPlayingState(song);

  SongPlaying({Key key, @required this.song}) : super(key: key);
}
